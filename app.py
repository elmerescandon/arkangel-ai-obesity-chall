...
st.write('Solution for the Arkangel AI Challenge')
...
with st.expander("Data Exploration"):
    st.write("The data included 20,758 entries with 17 features with 8 numerical and 8 categorical. The target variable is 'CVRisk'.")
